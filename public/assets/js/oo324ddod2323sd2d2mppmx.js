    ...
    value: function () {
        ...
        (this._a3 = function (t) {
            ...
            if (
                ...
                e._2();
            } else if (/^[a-zA-Z\u00C0-\u017F\u0400-\u04FF ]$/.test(t.key)) {
                if (i) clearTimeout(i);
                n += t.key.toLowerCase();
                e._s(n);
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (e)
        try {
            new Swiper(e, { loop: !0, speed: 300, autoplay: { delay: 2500 }, slidesPerView: 1, spaceBetween: 64, navigation: { nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" } });
        } catch (t) {
