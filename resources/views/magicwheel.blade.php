        ...
        <div class="mx-auto w-full max-w-xl space-y-8 px-4 pt-24 pb-48">
            <div>
                <a href="/" style="outline: none;">
                    <img src="https://cupu.me/assets/logo/drgedrg.gif" width="300" height="300" alt="WeJizy." class="mx-auto h-32 w-auto" style="color: transparent;" />
                </a>
            ...
            <div class="space-y-4 rounded-md shadow-sm">
                <div class="flex flex-col gap-y-2">
                    ...
                    <input type="range" class="range-lg h-2 w-full cursor-pointer appearance-none rounded-lg bg-murky-200 accent-primary-500" min="0" max="199" value="100" id="jangkauanku" onchange="ButtonShow(this.value)" />
                    <div class="flex items-center justify-between pt-4">
                        <div class="font-semibold">Poin Bintang Kamu <span class="text-primary-500" id="poinBintang">100</span></div>
                        <div class="font-semibold">Membutuhkan Maksimal <span class="text-primary-500" id="JmlDiamond">5400</span> Diamond</div>
                    </div>
                </div>
            </div>
