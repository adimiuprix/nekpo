...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('products')->insert([
            ...
            [
                'name' => 'Point Blank',
                'description' => 'Point Blank adalah game FPS online seru, penuh aksi cepat dan kompetitif antara tim Free Rebels dan CT-Force.',
                'slug' => Str::slug('point-blank'),
                'image' => 'point-blank.webp',
                'banner' => 'point-blank.webp',
                'vendor_id' => 36,
                'created_at' => now(),
                'updated_at' => now(),
            ],
